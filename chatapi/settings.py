...
SECRET_KEY = 'django-insecure-fdw_t(a43r*yuy=26c0a52e1^@#9-!*#)r%489nc^(z29#qe=c'
...
AWS_HOST_REGION = '%s.s3.amazons.com'% AWS_STORAGE_BUCKET_NAME
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'chatapi/static')]
