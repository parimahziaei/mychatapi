import jwt
from user_control.models import Jwt
...
class UserProfileView(ModelViewSet):
    ...
    def get_query(query_string, search_fields):
        ...
        query = None
        terms = UserProfileView.normalizer_query(query_string)
        for term in terms:
            or_query =None
    ...
    @staticmethod
    def normalizer_query(query_string, findterms=re.compile(r'"([^"]+)"|(\S+)').findall, normspace=re.compile(r'\s{2,}').sub):
